...
var fetchMessageHistory = /*#__PURE__*/function () {
    ...
    return _regenerator["default"].wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _messageService["default"].fetchMessageHistoryService(req.params.id);
        case 3:
  ...
  return function fetchMessageHistory(_x, _x2) {
    ...
    return _regenerator["default"].wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return _messageService["default"].fetchMoreMessageService(req.body);
        case 3:
